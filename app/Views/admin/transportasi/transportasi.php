...
<section>
  <h1 class="text-2xl font-bold text-secondary mb-8">Kelola Transportasi</h1>

  <div class="flex w-full justify-between mb-4">
    <a class="btn" href="transportasi/tambah">
    ...
    <table class="table table-zebra">
      <thead>
        <tr>
          ...
          <th class="bg-container text-secondary text-center">Kategori</th>
          <th class="bg-container text-secondary text-center">Operator</th>
          <th class="bg-container text-secondary text-center">Tipe</th>
          <th class="bg-container text-secondary text-center">Kapasitas</th>
      ...
      <?php foreach ($data as $row): ?>
        <tr class="hover">
          ...
          <td class="text-center flex justify-around">
            <a href="transportasi/edit/<?= $row['id'] ?>" class="link link-primary">Edit</a>
            <form action="/admin/transportasi/<?= $row['id'] ?>" id="form" method="post" class="action-form">
              <?=csrf_field() ?>
