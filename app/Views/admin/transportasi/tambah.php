    ...
    <div class="box-shadow-1 p-8">
        ...
        <form action="tambah" method="post" id="form">
            ...
            <div class="form-control w-full mb-4">
                ...
                <select
                    class="select select-bordered font-normal <?= (isset($validation['category'])) ? "select-error" : ""?>"
            ...
            <div class="form-control w-full mb-4">
                ...
                <input name="operator" id="operator" type="text" placeholder="Masukkan operator"
                    value="<?= old('operator') ?>"
                    class="input input-bordered w-full <?= (isset($validation['operator'])) ? "input-error" : ""?>"
                    autocomplete="off" />
            ...
            <div class="form-control w-full mb-4">
                ...
                <input name="type" id="type" type="text" placeholder="Masukkan tipe" value="<?= old('type') ?>"
                    class="input input-bordered w-full <?= (isset($validation['type'])) ? "input-error" : ""?>"
                    autocomplete="off" />
            ...
            <div class="form-control w-full mb-4">
                ...
                <input name="capacity" id="capacity" type="number" placeholder="Masukkan kapasitas"
                    value="<?= old('capacity') ?>"
                    class="input input-bordered w-full <?= (isset($validation['capacity'])) ? "input-error" : ""?>"
                    autocomplete="off" />
