...
<section>
  <h1 class="text-2xl font-bold text-secondary mb-8">Kelola Rute</h1>

  <div class="flex w-full justify-between mb-4">
    <a class="btn" href="rute/tambah">
    ...
    <table class="table table-zebra">
      <thead>
        <tr>
          ...
          <th class="bg-container text-secondary text-center">Asal</th>
          <th class="bg-container text-secondary text-center">Tujuan</th>
          <th class="bg-container text-secondary text-center">Jarak</th>
      ...
      <?php foreach ($data as $row): ?>
        <tr class="hover">
          ...
          <td class="text-center flex justify-around">
            <a href="rute/edit/<?= $row['id'] ?>" class="link link-primary">Edit</a>
            <form action="/admin/rute/<?= $row['id'] ?>" id="form" method="post" class="action-form">
              <?=csrf_field() ?>
