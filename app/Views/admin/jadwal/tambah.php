...
<section>
  <h1 class="text-2xl font-bold text-secondary mb-8">Tambah Jadwal</h1>
    ...
    <form action="tambah" method="post" id="form">
      ...
      <div class="form-control w-full mb-4">
        ...
        <select class="select select-bordered font-normal <?= (isset($validation['route_id'])) ? "select-error" : ""?>" name="route_id" id="route_id">
          ...
          <option <?= old('route_id') === $route['id'] ? 'selected' : ''; ?> value="<?= $route['id'] ?>"><?= $route['origin_destination'] ?></option>
          <?php endforeach; ?>
        </select>        
      ...
      <div class="form-control w-full mb-4">
        ...
        <select class="select select-bordered font-normal <?= (isset($validation['transportation_id'])) ? "select-error" : ""?>" name="transportation_id" id="transportation_id">
          ...
          <option <?= old('transportation_id') === $transportation['id'] ? 'selected' : ''; ?> value="<?= $transportation['id'] ?>"><?= $transportation['operator'] ?></option>
          <?php endforeach; ?>
        </select>        
      ...
      <div class="form-control w-full mb-4">
        ...
        <input name="time" id="time" type="time" placeholder="Masukkan waktu" value="<?= old('time') ?>" class="input input-bordered w-full <?= (isset($validation['time'])) ? "input-error" : ""?>"  autocomplete="off"/>
      ...
      <div class="form-control w-full mb-4">
        ...
        <input name="date" id="date" type="date" placeholder="Masukkan tanggal" value="<?= old('date') ?>" class="input input-bordered w-full <?= (isset($validation['date'])) ? "input-error" : ""?>"  autocomplete="off"/>
      ...
      <div class="form-control w-full mb-4">
        ...
        <input name="price" id="price" type="number" placeholder="Masukkan harga" value="<?= old('price') ?>" class="input input-bordered w-full <?= (isset($validation['price'])) ? "input-error" : ""?>"  autocomplete="off"/>
      ...
      <div class="form-control w-full mb-4">
        ...
        <input name="duration_trip" id="duration_trip" type="text" placeholder="Masukkan durasi perjalanan" value="<?= old('duration_trip') ?>" class="input input-bordered w-full <?= (isset($validation['duration_trip'])) ? "input-error" : ""?>"  autocomplete="off"/>
